import { streamSimple, type ToolResultMessage, type Usage } from "@earendil-works/pi-ai/compat";
...
export class AgentInterface extends LitElement {
	...
	public async sendMessage(input: string, attachments?: Attachment[]) {
		...
		// The current agent clears isStreaming after its final event listeners run.
		// Refresh once prompt() settles so controls observe the idle state.
		this.requestUpdate();
	}
